...
const jsonAttributes = (data) => {
    ...
    const html = `
        <section class="main-container blur">
            ...
            <h1>${convertToCelsius(data.main.temp)}ºC</h1>
            <h2>sensação de ${convertToCelsius(data.main.feels_like)}ºC</h2>
        ...
        <section class="informations blur">
            ...
            <div class="info-box">
                <p>Temperatura Mínima</p><span>${convertToCelsius(data.main.temp_min)}ºC</span>
            </div>
            <div class="info-box">
